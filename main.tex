...
The proof of \ruleref{rule:strong-löb} is less trivial, but it closely resembles the construction of the internal fixed point operator of \cref{def:fix} from the external one.
\begin{figure}
\begin{mathpar}
